...
window.onload = function(){
	...
	// texture load
	gl3.create_texture('image/sample.png',  0, loadCheck);
	gl3.create_texture('image/sample2.png', 1, loadCheck);
...
function init(){
	...
	var prg = gl3.program.create(
		...
		[3, 3, 4, 2],
		['mMatrix', 'mvpMatrix', 'invMatrix', 'lightPosition', 'eyePosition', 'centerPoint', 'ambientColor', 'texture', 'texture2'],
	...
	function render(){
		...
		prg.push_shader([mMatrix, mvpMatrix, invMatrix, lightPosition, cameraPosition, centerPoint, ambientColor, 0, 1]);
